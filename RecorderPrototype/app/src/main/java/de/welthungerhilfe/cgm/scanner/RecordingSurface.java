...
public class RecordingSurface {
    private static final String TAG = RecordingSurface.class.getSimpleName();
    ...
    private static final int NUM_FRAMES = 120;               // two seconds of video
     ...
     */
    public void testEncodeVideoToMp4(Context context) {
        // QVGA at 2Mbps
        mWidth = 640;
        mHeight = 480;
        mBitRate = 2000000;
        ...
        try {
            OUTPUT_DIR = new File(context.getExternalFilesDir(Environment.getDataDirectory().getAbsolutePath()).getAbsolutePath());
            prepareEncoder();
