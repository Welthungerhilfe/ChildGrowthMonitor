 ...
 * <p>
 * This activity extends the RecordActivity so there is something going on in the activity
 ...
 */
public class ScreenRecordActivity extends RecorderActivity {
...
/*
  ...
  private void startRecording() {
    ...
    try {
      File outputFile = getVideoOutputFile ();
